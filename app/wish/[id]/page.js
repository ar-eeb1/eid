                                ...
                                <AnimatePresence mode="wait">
                                    ...
                                    {(isClaimed || quizFinished) && (
                                        ...
                                        >
                                            ...
                                            {/* <button className="bg-white/10 hover:bg-white/20 text-white font-medium py-4 px-8 rounded-2xl transition-all inline-flex items-center gap-2">
                                                Say Thanks <Check className="w-5 h-5" />
                                            </button> */}
                                        </motion.div>
                                    )}
                                </AnimatePresence>
